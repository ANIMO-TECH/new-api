...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'health_probe_setting.enabled': false,
      'health_probe_setting.scan_interval_seconds': 30,
      'health_probe_setting.request_timeout_seconds': 120,
      'health_probe_setting.concurrency': 1,
      'health_probe_setting.initial_delay_seconds': 60,
      'health_probe_setting.backoff_multiplier': 2,
      'health_probe_setting.max_backoff_seconds': 3600,
      'health_probe_setting.max_attempts': 0,
      'health_probe_setting.notify_on_recovery': true,
      'health_probe_setting.notify_on_exhausted': true,
